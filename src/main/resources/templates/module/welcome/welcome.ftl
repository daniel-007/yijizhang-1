<div class="welcome-panel">
	...
	<table class="chart-btn-tb">
		<tr>
			<td>
				<button class="button button-glow button-rounded button-primary"><i class="fa fa-table"></i>&#8194;资产负债表</button>
			</td>
			<td>
				<button class="button button-glow button-rounded button-primary"><i class="fa fa-table"></i>&#8194;利润表</button>
			</td>
			<td>
				<button class="button button-glow button-rounded button-primary"><i class="fa fa-table"></i>&#8194;现金流量表</button>
			</td>
		</tr>
	</table>
