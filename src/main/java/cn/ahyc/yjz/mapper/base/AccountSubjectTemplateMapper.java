...
public interface AccountSubjectTemplateMapper {
	 ...
	 * to the database table account_subject_template
	 *
	 ...
	 * @mbggenerated Wed Sep 23 16:59:46 CST 2015
	 */
	int updateByExampleSelective(@Param("record") AccountSubjectTemplate record,
			@Param("example") AccountSubjectTemplateExample example);
	 ...
	 * @mbggenerated Wed Sep 23 16:59:46 CST 2015
	 */
	int updateByExample(@Param("record") AccountSubjectTemplate record,
			@Param("example") AccountSubjectTemplateExample example);
